        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form:form class="form-horizontal" role="form" action="${ctxPath}/mainPic/save" modelAttribute="mainPic" enctype="multipart/form-data" method="post">
                            <form:hidden path="id"/>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <form:input path="author"  class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <form:input path="content"  class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group row">
                                        <div class="col-sm-9">
                                            <form:input  path="time"  class="date-picker"   type="text" data-date-format="yyyy-mm-dd" />
                                        </div>
                                        <div class="col-sm-3">
